#!/bin/bash
# bucheon_260914 15degree batch: 15_a -> 15_b -> 15_c, mid360.yaml only
# (voxelslam-export matching, --rate 1.5, filter_size_surf=0.2), saved into
# each bag's mid360.yaml/voxel0.2/ subfolder (top-level mid360.yaml/
...
run_bag() {
    ...
    local outdir="$OUTROOT/$bagname/mid360.yaml/voxel0.2"
    local runname="bucheon_15deg_${bagname}_mid360_voxel0.2"
...
for bagname in 15_a 15_b 15_c; do
    run_bag "$bagname"
done
