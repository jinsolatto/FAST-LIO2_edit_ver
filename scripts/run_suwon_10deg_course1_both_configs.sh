#!/bin/bash
# bag_file/10degree/course1_minimize, both configs sequentially
# (voxelslam-export matching, --rate 1.0):
#   mid360.yaml  (filter_size_surf=0.2) -> suwon_260914/10degree/course1_minimize/mid360.yaml/voxel0.2/
#   siheung.yaml (filter_size_surf=0.5) -> suwon_260914/10degree/course1_minimize/siheung.yaml/voxel0.5/
#
...
BAG=/home/jschoi/bag_file/10degree/course1_minimize
OUTROOT="$REPO/suwon_260914/10degree/course1_minimize"
